...
export default function Dashboard(props: { searchParams: Promise<Message> }) {
  ...
  async function handleReport(formData: FormData) {
    ...
    const { error } = await supabase
      .from('reports')
      .insert({ user: user, shop: shop, platform: platform, link: link, confidence: 0 })
    ...
    <div className="mt-4 w-screen mx-auto flex flex-col items-center lg:flex-row lg:items-start lg:justify-around">
      ...
      <Tabs defaultValue="detect" className="p-4 lg:p-0 w-[400px]">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger disabled={detect} value="detect">Detect</TabsTrigger>
          <TabsTrigger disabled={detect} value="report">Report</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="detect">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Input the link to the product on any online shopping platform to check the reliability of the shop.
              </CardDescription>
            </CardHeader>
            <form action={handleDetect}>
              <CardContent className="space-y-2">
                <div className="space-y-1">
                  ...
                  <Input disabled={detect} id="product" name="product" placeholder="Enter product name" required />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <Input disabled={detect} id="link" name="link" type="url" placeholder="Enter link to product" required />
                </div>
              </CardContent>
              <CardFooter>
                <SubmitButton disabled={detect} pendingText="Loading..." className="w-full">
                  Check
                </SubmitButton>
              </CardFooter>
            </form>
        ...
        <TabsContent value="report">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Expose the fake shop to help our community!</CardDescription>
            </CardHeader>
            <form action={handleReport}>
              <CardContent className="space-y-2">
                <div className="space-y-1">
                  <Label htmlFor="shop">Shop Name</Label>
                  <Input id="shop" name="shop" type="text" placeholder="Enter shop name" required />
                </div>
                <div className="space-y-1">
                  <Label htmlFor="platform">Platform</Label>
                ...
                <div className="space-y-1">
                  <Label htmlFor="link">Link</Label>
                  <Input id="link" name="link" type="text" placeholder="Enter link to shop/product" required />
                </div>
                <div className="space-y-1">
                  <Label htmlFor="description">Description</Label>
                  <Input id="description" name="description" type="text" placeholder="What happened?" required />
                </div>
              </CardContent>
              <CardFooter>
