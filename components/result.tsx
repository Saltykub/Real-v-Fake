  ...
  return (
    <div>
      <div className="mt-8 lg:mt-0">
          <div className="max-w-screen-md mx-auto px-4 lg:px-0 flex flex-col justify-between">

              <div className="text-center">
                  <p className="text-sm leading-7 text-gray-500 font-regular">
                      Product Name
                  </p>
                  <h3 className="text-lg sm:text-2xl leading-normal font-bold tracking-tight text-gray-900">
                      {data.title} 
                  </h3>
                  <p className="mt-2 text-sm leading-7 text-gray-500 font-regular">${data.price}</p>
              </div>
